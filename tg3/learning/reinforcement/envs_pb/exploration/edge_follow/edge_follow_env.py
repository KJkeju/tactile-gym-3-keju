...
from tg3.learning.reinforcement.envs_pb.base_tactile_env import BaseTactileEnv
from tg3.simulator.assets import add_assets_path
from tg3.simulator.assets.default_rest_poses import rest_poses_dict
from tg3.simulator.embodiments.embodiments import VisuoTactileArmEmbodiment
from tg3.simulator.utils.setup_pb_utils import load_standard_environment
from tg3.simulator.utils.setup_pb_utils import set_debug_camera
...
class EdgeFollowEnv(BaseTactileEnv):
    ...
    def load_edge(self):
        ...
        edge_path = "object_assets/exploration/edge_follow/edge_stimuli/long_edge_flat/long_edge.urdf"
