...
from tg3.learning.reinforcement.envs_pb.nonprehensile_manipulation.base_object_env import BaseObjectEnv
from tg3.simulator.assets import add_assets_path
from tg3.simulator.assets.default_rest_poses import rest_poses_dict
from tg3.simulator.utils.transforms import inv_transform_eul
...
class ObjectRollEnv(BaseObjectEnv):
    ...
    def setup_object(self):
        ...
        if self._env_params['show_gui']:
            self.object_path = add_assets_path("object_assets/nonprehensile_manipulation/object_roll/sphere/sphere_tex.urdf")
        else:
            self.object_path = add_assets_path("object_assets/nonprehensile_manipulation/object_roll/sphere/sphere.urdf")

        self.goal_path = add_assets_path("object_assets/nonprehensile_manipulation/object_roll/sphere/sphere.urdf")
