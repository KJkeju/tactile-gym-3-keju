...
from tg3.learning.reinforcement.envs_pb.nonprehensile_manipulation.object_push.rest_poses import rest_poses_dict
...
class ObjectPushEnv(BaseObjectEnv):
    ...
    def setup_object(self):
        ...
        # get paths
        self.object_path = add_assets_path("object_assets/nonprehensile_manipulation/object_push/cube/cube.urdf")
