...
from tg3.learning.reinforcement.envs_pb.nonprehensile_manipulation.object_balance.rest_poses import rest_poses_dict
from tg3.simulator.assets import add_assets_path
from tg3.simulator.utils.pybullet_draw_utils import draw_vector
...
class ObjectBalanceEnv(BaseObjectEnv):
    ...
    def setup_object(self):
        ...
        self.object_path = add_assets_path("object_assets/nonprehensile_manipulation/object_balance/pole/pole.urdf")
