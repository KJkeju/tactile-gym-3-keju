...
def setup_parse(
    ...
    parser.add_argument('-i', '--input', type=str, help="Default: './ur_tactip'.", default=input)
    parser.add_argument('-e', '--experiments', nargs='+', help="Options: ['edge_yRz']", default=experiments)
    parser.add_argument('-o', '--target', type=str, help="Default: '/sim_tactip'", default=target)
    parser.add_argument('-t', '--train_dirs', nargs='+', help="Default: ['data_train']", default=train_dirs)
    parser.add_argument('-v', '--val_dirs', nargs='+', help="Default: ['data_val']", default=val_dirs)
    parser.add_argument('-m', '--models', nargs='+', help="Options: ['pix2pix','shpix2pix']", default=models)
    parser.add_argument('-c', '--device', type=str, help="Options: ['cpu', 'cuda']", default=device)
