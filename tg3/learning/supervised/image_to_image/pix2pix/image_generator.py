...
from tg3.learning.supervised.image_to_image.setup_training import setup_parse, setup_model_image
...
class Image2ImageGenerator(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # preprocess/augment images separately
        processed_input_image = transform_image(
            raw_input_image,
            gray=True,
            bbox=self._bbox,
            dims=self._dims,
        ...
        processed_target_image = transform_image(
            raw_target_image,
            gray=True,
            bbox=None,
            dims=self._dims,
...
if __name__ == '__main__':
    ...
    args = setup_parse(
        ...
        train_dirs=['data_train','data_val'],
    )
