...
try:
    ...
    pass    # Vit not available, will raise error later if needed

from tg3.learning.supervised.image_to_feature.cnn.setup_model import weights_init_normal, CNN, NatureCNN, ResNet, ResidualBlock
