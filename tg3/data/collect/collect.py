...
from tg3.data.setup_collect import POSE_LABEL_NAMES, SHEAR_LABEL_NAMES, OBJECT_POSE_LABEL_NAMES
from tg3.data.collect.setup_embodiment import setup_embodiment
from tg3.data.collect.setup_targets import setup_targets
from tg3.utils.utils import make_dir, save_json_obj
...
if __name__ == "__main__":
    ...
    for data_dir_name, num_poses in data_params.items():
        ...
        # setup save dir
        save_dir = os.path.join(path, data_dir_name)
