...
from data.process.marker_extraction_methods import MarkerDetector
from data.process.process_images import combine_bbox
from data.process.transform_image import transform_image
from data.setup_collect import DATA_PATH
from utils.utils import save_json_obj, load_json_obj
...
if __name__ == "__main__":
    ...
    process_marker_data(DATA_PATH, dir_names, marker_params, image_params)
