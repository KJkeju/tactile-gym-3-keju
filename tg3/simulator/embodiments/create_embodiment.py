...
from tg3.simulator.embodiments.embodiments import ArmEmbodiment
from tg3.simulator.embodiments.embodiments import TactileArmEmbodiment
from tg3.simulator.embodiments.embodiments import VisualArmEmbodiment
...
def create_embodiment(pb, embodiment_type, robot_arm_params, tactile_sensor_params, visual_sensor_params):
    ...
    if embodiment_type == 'arm':
        ...
        print('[DEBUG] create_embodiment: tactile_sensor_params:', tactile_sensor_params)
